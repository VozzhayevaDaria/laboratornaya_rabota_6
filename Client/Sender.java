...
public class Sender {
    public void send(DatagramSocket soc, CommandData data, int SERVERPORT) throws IOException {
        ...
        DatagramPacket datagramPacket = new DatagramPacket(serialisedData.getBytes(), serialisedData.getBytes().length, adress, SERVERPORT);
