...
public class Reciever {
    public String[] getData(DatagramSocket soc) throws IOException {
        ...
        return this.DeserialiseData(concatSerialisedMessages);
    }

    public String[] DeserialiseData(String data) throws JsonProcessingException {
